...
* OpenSearch for holding the data as the main datastore
...
and moving them from the current RabbitMQ deployments OpenStack uses to the OpenSearch storage that Hermes uses.
